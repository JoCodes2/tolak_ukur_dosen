...
<head>
    ...
    <title>Login | SIPEDE - Sistem Informasi Pengelolaan Data Evaluasi</title>
    ...
    <div class="login-wrapper">
        ...
        <div class="branding-section">
            <div class="text-center">
                <h1 class="brand-title">Sistem Informasi Pengelolaan Data Evaluasi</h1>
        ...
        <div class="login-section">
            <div class="login-card">
                <div class="login-header">
                    ...
                    <p>Silakan login untuk mengakses Sistem Informasi Pengelolaan Data Evaluasi.</p>
                </div>
