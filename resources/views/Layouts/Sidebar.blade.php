<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner pt-3">
        ...
        <li class="menu-item {{ request()->is('prodi*') ? 'active' : '' }}">
            <a href="/prodi" class="menu-link"><i class="menu-icon fa-solid fa-graduation-cap"></i><div data-i18n="Program Studi">Program Studi</div></a>
        </li>
        <li class="menu-item {{ request()->is('kelas*') ? 'active' : '' }}">
            <a href="/kelas" class="menu-link"><i class="menu-icon fa-solid fa-chalkboard-user"></i><div data-i18n="Kelas">Kelas</div></a>
        </li>
        <li class="menu-item {{ request()->is('mahasiswa*') ? 'active' : '' }}">
            <a href="/mahasiswa" class="menu-link"><i class="menu-icon fa-solid fa-users"></i><div data-i18n="Mahasiswa">Mahasiswa</div></a>
        </li>
        <li class="menu-item {{ request()->is('matakuliah*') ? 'active' : '' }}">
            <a href="/matakuliah" class="menu-link"><i class="menu-icon fa-solid fa-book"></i><div data-i18n="Matakuliah">Matakuliah</div></a>
        </li>
        ...
        <li class="menu-item {{ request()->is('kontrak-perkuliahan*') ? 'active' : '' }}">
            <a href="/kontrak-perkuliahan" class="menu-link">
                <i class="menu-icon fa-solid fa-file-signature"></i>
                <div data-i18n="Kontrak">Kontrak Perkuliahan</div>
            </a>
        </li>
